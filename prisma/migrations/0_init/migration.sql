...
CREATE TABLE "laptop_model" (
    ...
    CONSTRAINT "laptop_model_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "laptop_owner" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "created_at" TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "laptop_owner_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "service_ticket" (
    ...
    CONSTRAINT "service_ticket_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "warranty_details" (
    ...
    CONSTRAINT "warranty_details_pkey" PRIMARY KEY ("id")
);
