...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Laptop repair shop`}</title>

        <meta
          name="description"
          content="Laptop Repair Shop - Ensuring the longevity of your device by meticulously logging each service history of your laptop. Your trusted partner in laptop maintenance."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsYXB0b3B8ZW58MHx8fHwxNjk1NDA5MTA1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@karishea?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Kari Shea`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Laptop Repair Shop - Ensuring the longevity of your device by meticulously logging each service history of your laptop. Your trusted partner in laptop maintenance.`}
            </Text>
            <Box
