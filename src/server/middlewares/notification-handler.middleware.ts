...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Service Request Created.create': {
    roles: ['business-owner', 'it-manager', 'service-technician', 'customer-service-representative'],
    key: 'service_request',
    tenantPath: [],
    userPath: [],
  },
  'Service Request Updated.update': {
    roles: ['business-owner', 'it-manager', 'service-technician', 'customer-service-representative'],
    key: 'service_update',
    tenantPath: [],
    userPath: [],
  },
  'Feedback Received.create': {
    roles: ['business-owner', 'it-manager', 'service-technician', 'customer-service-representative'],
    key: 'feedback',
    tenantPath: [],
    userPath: [],
